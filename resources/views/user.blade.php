...
@section('content')
<h1>ユーザー一覧</h1>
<section class="coupon-list users-list">
	...
	<article class="general-box coupon-card" tabindex="0" role="article" onclick="location.href='{{ route('admin.user.detail', ['id' => $user->id]) }}'">
