...
export function initProfileIconHandler(): void {
    const fileInput = document.getElementById('avatar-img') as HTMLInputElement | null;
    const previewImage = document.getElementById('profile-preview') as HTMLImageElement | null;
