...
\begin{itemize}
	...
	「県や町単位のため、近隣でどのような観光ができるのかわかりにくい」という
	不満が
	多いとされており、
	周遊の機会が失われていると考えられます。
...
\item \emph{集客機会の損失:}
	...
	その観光スポットのみに集中するのみで入店に繋がらず、収益が得られない
	といったことがあります。
...
\section{課題解決のための提案}
上記の課題、特に高知県が公式に
特定した「データ活用の不足」と「周遊コンテンツの不足」\cite{kochi_dx_plan}
...
\begin{itemize}
	...
	「この近くで、（作品中）に出てきたような風景や景色が眺められる喫茶店は？」
...
\begin{itemize}
	...
	\begin{itemize}
		...
		クーポンの利用履歴、また、AIへの検索クエリに加え、閲覧された口コミや
		写真を収集します。
		\item \textbf{分析・提供方法:}
...
\begin{itemize}
	\item \emph{初期費用（開発費）:}
		\begin{itemize}
			\item 人件費: $\text{10,000,000円/年}\times\text{7名}
			\times\text{5ヶ月}
			\sim\text{29,166,667円}$
			\item その他（機材費など）: 0円\\
	...
	\item \emph{運用費用（5年間）:}
		\begin{itemize}
			...
			=\text{0円}$
			\item 維持管理費（人件費など）: $\text{2,916,667円/年}
			\times\text{60ヶ月}
			\sim\text{14,583,333円}$\\
			（年間費用は初期費用の1割として計算）
		\end{itemize}
...
\begin{thebibliography}{99}
	...
	“聖地巡礼で観光はどう変わる？地域活性化の鍵を握る
	新たな可能性｜コラム｜TOPPAN SOCIAL INNOVATION”，
	2025年，
