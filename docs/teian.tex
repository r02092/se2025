...
\begin{itemize}
	...
	\begin{itemize}
		\item \emph{高知県観光DX推進計画\cite{kochi_dx_plan}}が
...
\begin{thebibliography}{99}
	...
	じゃらんリサーチセンター，
	“コンテンツツーリズム全般を大規模調査！「じゃらん映像コンテンツ コンテンツツーリズム調査」調査報告書 | じゃらんリサーチセンター”，
	2024年，
	...
	国土交通省観光庁，
	“地方誘客に資する各種のコンテンツ整備 | 地方誘客に効果の高いコンテンツの整備 | インバウンド回復戦略 | 観光政策・制度 | 観光庁”，
	2024年，
