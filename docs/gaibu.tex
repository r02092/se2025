...
\begin{figure}[H]
	...
	\adiagram{利用者,システム,データベース}{1.2}{
		...
		\node[action](decision0)at(1,-14){不備がある旨を表示};
		\draw[arrow](action11)-|(1.45,-14)node[label,pos=.57]{不備がある}|-(decision0);
...
\begin{figure}[H]
	...
	\adiagram{利用者,システム,データベース}{1.5}{
		...
		\node[action](decision0)at(1,-10){存在しない旨を表示};
		\draw[arrow](action8)-|(1.45,-10)node[label,pos=.57]{存在しない}|-(decision0);
		\draw[arrow](decision0)--(action10);
	}
...
\begin{figure}[H]
	...
	\adiagram{管理者,システム,データベース}{1.5}{
		...
		\node[action](decision1)at(1,-12){返信できない旨を表示};
		\draw[arrow](action8)-|(1.45,-11)node[label,pos=.57]{不備がある}|-(decision1);
		\draw[arrow](decision1)--(action12);
	}
