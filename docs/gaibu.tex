...
することが可能です。
これにより、正しいデータを事業者や行政に提供することが
できます。

\subsubsection{問い合わせ対応機能}
管理者はユーザーからの問い合わせに対応することができます。
...
観光客が、システムを利用するためのアカウントを作成することができます。
作成の際には、ユーザー名、パスワード等を登録します。
...
観光客は、作成した観光ルートをGoogle Mapsに連携できます。
これにより、ナビゲーションやルート案内をGoogle Mapsで利用できます。
...
観光客は、訪れた観光地や施設のスタンプをつけることができます。
...
\begin{figure}[H]
	\centering
	\includegraphics[bb=16.652460 159.317995 824.542569 586.835982,clip,scale=.55]{gaibu-er.pdf}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		user\_id & INT UNSIGNED & FK, NOT NULL & 関連付けた利用者 \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		user\_id & INT UNSIGNED & FK, UK1, NOT NULL & 関連付けた利用者 \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		id & INT UNSIGNED & PK & ID \\ \hline
		spot\_id & INT UNSIGNED & FK, UK, NOT NULL & 関連付けたスポット \\ \hline
		user\_id & INT UNSIGNED & FK, UK, NOT NULL & 関連付けた利用者 \\ \hline
		ip\_addr & VARBINARY(16) & NOT NULL & IPアドレス \\ \hline
		port & SMALLINT UNSIGNED & NOT NULL & ポート番号 \\ \hline
		user\_agent & VARCHAR(255) & NOT NULL & User-Agent \\ \hline
		created\_at & DATETIME & & 作成時刻 \\ \hline
