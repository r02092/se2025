...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/profile.png}
	\caption{アカウント情報確認}\label{fig:ui-profile}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/profile-edit.png}
	\caption{アカウント情報編集}\label{fig:ui-profile-edit}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/subscription-form.png}
	\caption{事業者申込}\label{fig:ui-subscription-form}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/subscription-confirm.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/logined_home.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/logout.png}
	\caption{ログアウト}\label{fig:ui-logout}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/photo.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/coupon-selected.png}
	\caption{クーポン使用}\label{fig:ui-coupon-selected}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/coupon-QR.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/funpage-checkin.png}
	\caption{チェックイン}\label{fig:ui-funpage-checkin}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/funpage-checkin-failed.png}
	\caption{チェックイン（失敗）}\label{fig:ui-funpage-checkin-failed}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/funpage-checkin-got.png}
	\caption{チェックイン（無効）}\label{fig:ui-funpage-got}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/funpage-checkined.png}
	\caption{チェックイン完了}\label{fig:ui-funpage-checkined}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/admin.png}
	\caption{管理者機能ホーム}\label{fig:ui-admin}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/user.png}
	\caption{ユーザー一覧}\label{fig:ui-user}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/user-detail.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/spot.png}
	\caption{スポット情報編集（上部）}\label{fig:ui-spot}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/spot2.png}
	\caption{スポット情報編集（下部）}\label{fig:ui-spot2}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/data.png}
	\caption{観光データ確認}\label{fig:ui-data}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/business.png}
	\caption{事業者機能ホーム}\label{fig:ui-business}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=.23]{ui/api.png}
