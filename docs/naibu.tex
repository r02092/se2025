...
\subsection{ディレクトリ構造}\label{sec:dir}
...
\begin{table}[H]
	...
	\modtable{MC01}{LoginController.php}%
...
\begin{table}[H]
	...
	\modtable{MC02}{AccountCreateController.php}%
...
\begin{table}[H]
	...
	\modtable{MC04}{BlankCheckTrait.php}%
...
\begin{table}[H]
	...
	\modtable{MC05}{SpecialCharCheckTrait.php}%
...
\begin{table}[H]
	...
	\modtable{MC06}{DupLoginNameCheckTrait.php}%
...
\begin{table}[H]
	...
	\modtable{MC07}{LogoutController.php}%
	{SceneTripのログアウトを行う。}%
	{
		node [shape=box,style=rounded];
		b [shape=diamond];
...
\begin{table}[H]
	...
	\modtable{MC08}{ProfileController.php}%
...
\begin{table}[H]
	...
	\modtable{MC09}{ProfileEditController.php}%
...
\begin{table}[H]
	...
	\modtable{MC00}{SearchController.php}%
	{検索画面を表示するモジュール}%
	{
		node [shape=diamond];
		node [shape=box,style=rounded];
...
\begin{table}[H]
	...
	\modtable{MU11}{SearchApiController.php}%
	{キーワード・カテゴリに基づくスポット検索}%
	{
		node [shape=diamond];
		node [shape=box,style=rounded];
		a [label="検索開始", shape=oval];
...
\begin{table}[H]
	...
	\modtable{MU13}{AiApiController.php}
...
\begin{table}[H]
	...
	\modtable{MU14}{CheckinApiController.php}{QRコードと位置情報によるスタンプ付与}
	{
		node [shape=diamond];
		node [shape=box,style=rounded];
		start [label="開始", shape=oval];
...
\begin{table}[H]
	...
	\modtable{MU15}{ReviewController.php}{評価と写真をシステムに登録する}%
	{
		node [shape=diamond];
		node [shape=box,style=rounded];
		start [label="開始", shape=oval];
...
\begin{table}[H]
	...
	\modtable{MU16}{CouponTrait.php}{スタンプ獲得状況に基づくクーポン付与}%
	{
		node [shape=diamond];
		node [shape=box,style=rounded];
		start [label="開始", shape=oval];
...
\begin{table}[H]
	\centering
	\caption{観光地・施設情報追加画面の表示}\label{tab:mod-add-spot}
	\modtable{MA01}{InsertSpotController.php}%
...
\begin{table}[H]
	\centering
	\caption{観光地・施設情報編集画面の表示}\label{tab:mod-edit-spot}
	\modtable{MA02}{EditSpotController.php}%
...
\begin{table}[H]
	\centering
	\caption{観光地・施設情報削除画面の表示}\label{tab:mod-delete-spot}
	\modtable{MA03}{DeleteSpotController.php}%
...
\begin{table}[H]
	\centering
	\caption{ユーザー情報追加画面の表示}\label{tab:mod-add-user}
	\modtable{MA04}{InsertUserController.php}%
...
\begin{table}[H]
	\centering
	\caption{ユーザー情報編集画面の表示}\label{tab:mod-edit-user}
	\modtable{MA05}{EditUserController.php}%
...
\begin{table}[H]
	\centering
	\caption{ユーザー情報削除画面の表示}\label{tab:mod-delete-user}
	\modtable{MA06}{DeleteUserController.php}%
...
\begin{table}[H]
	\centering
	\caption{UGC監視・管理画面の表示}\label{tab:mod-admin-ugc}
	\modtable{MA07}{AdminUgcController.php}%
...
\begin{table}[H]
	\centering
	\caption{サブスクリプション承認画面の表示}\label{tab:mod-approve-subs}
	\modtable{MA08}{SubscriptionApproveController.php}%
...
\begin{table}[H]
	\centering
	\caption{サブスクリプション解除画面の表示}\label{tab:mod-cancel-subs}
	\modtable{MA09}{SubscriptionCancelController.php}%
