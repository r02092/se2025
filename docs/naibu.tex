...
\begin{enumerate}
	...
	（例: \cref{tab:mod-addr-ex}の〒782--0000）\\
	結果を空文字列として処理を終了する。
	\item 町域名が/（([１-９][０-９]*階|地階・階層不明)）\textdollar/に
	マッチするとき
	（例: \cref{tab:mod-addr-ex}の名古屋市中村区のもの）\\
	結果を空文字列として処理を終了する。
	\item 町域名が/\textasciicircum(.+)（.+）\textdollar/にマッチするとき
	（例: \cref{tab:mod-addr-ex}の〒782--0077）\\
