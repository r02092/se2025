...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|}
		...
		currentUserNum & number & 現在のサービスの利用者数 \\ \hline
		spotData & Array of Object & スポットに関するデータ（参照: \cref{tab:api-response_spots}） \\ \hline
		couponData & Array of Object & クーポンに関するデータ（参照: \cref{tab:api-response_coupons}） \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|}
		...
		acquisitionNum & number & 取得した利用者数 \\ \hline
		useNum & number & 使用した利用者数 \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|l|l|l|l|}
		...
		利用者一覧画面 & MV51 & user.blade.php \\ \hline
		利用者詳細画面 & MV52 & user-detail.blade.php \\ \hline
