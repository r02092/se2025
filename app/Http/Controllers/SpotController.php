...
class SpotController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $spot = Spot::create([...$validated, 'status' => 'pending']);

        return redirect()
            ->route('admin.spots.index')
            ->with(
                'success',
                'スポットの追加申請を受け付けました。承認をお待ちください。',
            );
    }
